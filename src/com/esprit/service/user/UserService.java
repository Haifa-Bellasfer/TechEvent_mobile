...
public class UserService {
    ...
    public void login(String username, String password) {
        ...
        con.setUrl(Session.url_server + "profil/login/login/" + username + "/" + password);
    ...
    public void register(String username, String firstname, String lastname, String password, String phone, String address, String email) {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(Session.url_server + "profil/register/register/" + username + "/" + firstname + "/" + lastname + "/" + password + "/" + phone + "/" + address + "/" + email);
    ...
    public void getCurrUser(String username) {
        ...
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(Session.url_server + "profil/login/getuser/" + username);
        con.addResponseListener((NetworkEvent evt) -> {
            String rep = new String(con.getResponseData());
            parseUser(rep, Session.current_user);
        });
        NetworkManager.getInstance().addToQueueAndWait(con);
    }
    ...
    public ArrayList<Story> profile(int id) {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(Session.url_server + "profil/profile/" + id);
    ...
    public void publishStory(int id, String content) {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(Session.url_server + "profil/publish/publish/" + id + "/" + content);
        NetworkManager.getInstance().addToQueue(con);
    }
}
