...
public class CommentService {
    ...
    public void ajoutComment(Comment c) {
        ...
        String Url = Session.url_server + "Api/Comment/ajouter?comment=" + c.getContent() + "&iduser=" + Session.current_user.getId_user() + "&idevent=" + Session.current_event.getId_event();
    ...
    public ArrayList<Comment> getList2(int idevent) {
        ...
        con.setUrl(Session.url_server + "Api/Comment/aff/" + idevent);
    ...
    public void deleteComment(Comment c) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = Session.url_server + "Api/Comment/del/" + c.getId_comment();
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion
    ...
    public void updateComment(Comment c) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = Session.url_server + "Api/Comment/upd/" + c.getId_comment() + '/' + c.getContent();
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion
