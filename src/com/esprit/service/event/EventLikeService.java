...
public class EventLikeService {
    ...
    public ArrayList<event_likes> getEventLike() {
        ...
        con.setUrl("http://localhost/PIDEV/dorsaf/TechEvent/web/Api/AfficheLike");
     ...
     public void ajout(event_likes ev) {
        ConnectionRequest con = new ConnectionRequest();
        String Url ="http://localhost/PIDEV/dorsaf/TechEvent/web/Api/like?idevent="+ev.getEvent_id()+"&iduser="+ev.getUser_id();// création de l'URL
        con.setUrl(Url);
