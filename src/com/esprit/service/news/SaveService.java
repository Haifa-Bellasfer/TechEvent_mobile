...
public class SaveService {
    ...
    public boolean isSaved(Article article) {
        return this.getList().contains(article);
    }
    ...
    public ArrayList<Article> getList() {
        ...
        con.setUrl(Session.url_server + "news/all/" + Session.current_user.getId_user());
    ...
    public void save(Article instance, User current_user) {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(Session.url_server + "news/save/" + instance.getIdArticle() + "/" + current_user.getId_user());
        NetworkManager.getInstance().addToQueueAndWait(con);
    }

    public void unsave(Article instance, User current_user) {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(Session.url_server + "news/unsave/" + instance.getIdArticle() + "/" + current_user.getId_user());
        NetworkManager.getInstance().addToQueueAndWait(con);
    }
